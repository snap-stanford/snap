...
Plot the number of nodes in k-core of a graph as a function of k.
...
A k-core of G can be obtained by recursively removing all the vertices of degree 
less than k, until all vertices in the remaining graph have degree at least k.
