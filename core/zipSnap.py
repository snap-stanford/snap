...
def Main() :
  ...
  FileList = FileList + GetFileList('examples/concomp', '*.cpp|*.h|*.txt|*.vcproj|Makefile', '')
  FileList = FileList + GetFileList('examples/forestfire', '*.cpp|*.h|*.txt|*.vcproj|Makefile', '')
  FileList = FileList + GetFileList('examples/kronfit', '*.cpp|*.h|*.txt|*.vcproj|Makefile', '')
  FileList = FileList + GetFileList('examples/krongen', '*.cpp|*.h|*.txt|*.vcproj|Makefile', '')
  FileList = FileList + GetFileList('examples/mkdatasets', '*.cpp|*.h|*.txt|*.vcproj|Makefile', '')
  FileList = FileList + GetFileList('examples/ncpplot', '*.cpp|*.h|*.txt|*.vcproj|Makefile', '')
  FileList = FileList + GetFileList('examples/netevol', '*.cpp|*.h|*.txt|*.vcproj|Makefile', '')
  FileList = FileList + GetFileList('examples/netstat', '*.cpp|*.h|*.txt|*.vcproj|Makefile', '')
