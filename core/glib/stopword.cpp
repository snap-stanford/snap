...
void TSwSet::AddEs(){
  ...
  //MultiAdd(
  //  "A.ACÁ.AHÍ.AJENA.AJENAS.AJENO.AJENOS.AL.ALGO.ALGUNA.ALGUNAS.ALGUNO.ALGUNOS."
  //  "ALGÚN.ALLÁ.ALLÍ.AMBOS.ANTE.ANTES.AQUEL.AQUELLA.AQUELLAS.AQUELLO.AQUELLOS."
  //  "AQUI.AQUÍ.ARRIBA.ATRAS.ATRÁS.BAJO.BASTANTE.BIEN.BIÉN.CADA.CERCA.CIERTA."
  //  "CIERTAS.CIERTO.CIERTOS.COMO.CÓMO.CON.CONMIGO.CONSEGUIMOS.CONSEGUIR.CONSIGO."
  //  "CONSIGUE.CONSIGUEN.CONSIGUES.CONTIGO.CONTRA.CUAL.CUALES.CUALQUIER.CUALQUIERA."
  //  "CUALQUIERAS.CUAN.CUANDO.CUANTA.CUANTAS.CUANTO.CUANTOS.CUÁN.CUÁNTA.CUÁNTAS."
  //  "CUÁNTO.CUÁNTOS.CÓMO.DE.DEJAR.DEL.DEMASIADA.DEMASIADAS.DEMASIADO.DEMASIADOS."
  //  "DEMÁS.DENTRO.DESDE.DESPUÉS.DONDE.DOS.DÓNDE.E.EL.ELLA.ELLAS.ELLOS.EMPLEAIS."
  //  "EMPLEAN.EMPLEAR.EMPLEAS.EMPLEO.EN.ENCIMA.ENTONCES.ENTRE.ERA.ERAMOS.ERAN."
  //  "ERAS.ERES.ES.ESA.ESAS.ESE.ESOS.ESTA.ESTABA.ESTADO.ESTAIS.ESTAMOS.ESTAN."
  //  "ESTAR.ESTAS.ESTE.ESTOS.ESTOY.ESTÁ.ESTÁIS.FIN.FUE.FUERON.FUI.FUIMOS.HA."
  //  "HABER.HACE.HACEIS.HACEMOS.HACEN.HACER.HACES.HAGO.HAN.HASTA.INCLUSO.INTENTA."
  //  "INTENTAIS.INTENTAMOS.INTENTAN.INTENTAR.INTENTAS.INTENTO.IR.JAMÁS.JUNTO.JUNTOS."
  //  "LA.LARGO.LAS.LE.LO.LOS.MAS.ME.MENOS.MIA.MIENTRAS.MIO.MISMA.MISMAS.MISMO."
  //  "MISMOS.MODO.MUCHA.MUCHAS.MUCHO.MUCHOS.MUCHÍSIMA.MUCHÍSIMAS.MUCHÍSIMO.MUCHÍSIMOS."
  //  "MUY.MÁS.MÍA.MÍO.NADA.NI.NINGUNA.NINGUNAS.NINGUNO.NINGUNOS.NO.NOS.NOSOTRAS."
  //  "NOSOTROS.NUESTRA.NUESTRAS.NUESTRO.NUESTROS.NUNCA.O.Ó.OS.OTRA.OTRAS.OTRO."
  //  "OTROS.PARA.PARECER.PER.PERO.POCA.POCAS.POCO.POCOS.PODEIS.PODEMOS.PODER."
  //  "PODRIA.PODRIAIS.PODRIAMOS.PODRIAN.PODRIAS.PODRÍA.PODRÍAIS.PODRÍAMOS.PODRÍAN."
  //  "PODRÍAS.POR.PORQUE.PORQUÉ.PRIMERO.PUEDE.PUEDEN.PUEDO.PUES.QUE.QUERER.QUIENESQUIERA."
  //  "QUIENQUIERA.QUÉ.SABE.SABEIS.SABEMOS.SABEN.SABER.SABES.SE.SER.SI.SIDO.SIEMPRE."
  //  "SIENDO.SIN.SOBRE.SOIS.SOLAMENTE.SOLO.SOMOS.SOY.SR.SRA.SRES.STA.SU.SUS.SUYA."
  //  "SUYAS.SUYO.SUYOS.SÍ.SÍN.SÓLO.TAL.TALES.TAMBIÉN.TAN.TANTA.TANTAS.TANTO."
  //  "TANTOS.TE.TENEIS.TENEMOS.TENER.TENGO.TI.TIENE.TIENEN.TODA.TODAS.TODO.TODOS."
  //  "TOMAR.TRAS.TUYA.TUYO.TÚ.ULTIMO.UN.UNA.UNAS.UNO.UNOS.USA.USAIS.USAMOS.USAN."
  //  "USAR.USAS.USO.USTED.USTEDES.VA.VAIS.VALOR.VAMOS.VAN.VARIAS.VARIOS.VAYA."
  //  "VERDAD.VERDADERA.VERDADERO.VOSOTRAS.VOSOTROS.VOY.VUESTRA.VUESTRAS.VUESTRO."
  //  "VUESTROS.Y.YA.YO.ÉL.ÉRAMOS.ÉSTAS.ÉSTE.");
}
