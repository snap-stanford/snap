...
void test_ints(){
  ...
  PNGraphMP pngraphmp_2 = TSnap::ToGraphMP2<PNGraphMP>(wikitable,schema[0].GetVal1(),schema[1].GetVal1());
  ...
  PNEANetMP pneanetmp = TSnap::ToTNEANetMP(wikitable,schema[0].GetVal1(),schema[1].GetVal1());
  printf("Made the PNEANetMP of %d nodes and %d edges.\n", (*pneanetmp).GetNodes(),(*pneanet).GetEdges());

  PNEANetMP pneanetmp2 = TSnap::ToTNEANetMP2(wikitable,schema[0].GetVal1(),schema[1].GetVal1());
