...
private:
  ...
  static const unsigned int alpha = 4;
...
template<class PGraph>
bool TBreathFS_Hybrid<PGraph>::TopDownStep(TIntV *Frontier, TIntV *NextFrontier, int& MaxDist, const int& TargetNId, const bool& FollowOut, const bool& FollowIn) {
...
template<class PGraph>
bool TBreathFS_Hybrid<PGraph>::BottomUpStep(TIntV *Frontier, TIntV *NextFrontier, int& MaxDist, const int& TargetNId, const bool& FollowOut, const bool& FollowIn) {
