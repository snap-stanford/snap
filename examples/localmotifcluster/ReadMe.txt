...
The example implements the MAPPR local clustering algorithm for
finding sets of nodes in a directed/undirected graph around a targeted
seed node with low motif conductance.
