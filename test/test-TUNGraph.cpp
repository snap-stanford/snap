...
TEST(TUNGraph, AddSAttrDatN_int) {
  PUNGraph Graph;
  Graph = TUNGraph::New();
  Graph->AddNode(0);
  TInt Val(5);
...
TEST(TUNGraph, AddSAttrDatN_flt) {
  PUNGraph Graph;
  Graph = TUNGraph::New();
  Graph->AddNode(0);
  TFlt Val(5.0);
...
TEST(TUNGraph, AddSAttrDatN_str) {
  PUNGraph Graph;
  Graph = TUNGraph::New();
  Graph->AddNode(0);
  TStr Val("5");
...
TEST(TUNGraph, GetSAttrDatN_int) {
  PUNGraph Graph;
  Graph = TUNGraph::New();
  Graph->AddNode(0);
  TInt Val;
...
TEST(TUNGraph, GetSAttrDatN_flt) {
  PUNGraph Graph;
  Graph = TUNGraph::New();
  Graph->AddNode(0);
  TFlt Val;
...
TEST(TUNGraph, GetSAttrDatN_str) {
  PUNGraph Graph;
  Graph = TUNGraph::New();
  Graph->AddNode(0);
  TStr Val;
...
TEST(TUNGraph, AddSAttrDatE_int) {
  PUNGraph Graph;
  Graph = TUNGraph::New();
  Graph->AddNode(0);
  Graph->AddNode(1);
...
TEST(TUNGraph, AddSAttrDatE_flt) {
  PUNGraph Graph;
  Graph = TUNGraph::New();
  Graph->AddNode(0);
  Graph->AddNode(1);
...
TEST(TUNGraph, AddSAttrDatE_str) {
  PUNGraph Graph;
  Graph = TUNGraph::New();
  Graph->AddNode(0);
  Graph->AddNode(1);
...
TEST(TUNGraph, GetSAttrDatE_int) {
  PUNGraph Graph;
  Graph = TUNGraph::New();
  Graph->AddNode(0);
  Graph->AddNode(1);
...
TEST(TUNGraph, GetSAttrDatE_flt) {
  PUNGraph Graph;
  Graph = TUNGraph::New();
  Graph->AddNode(0);
  Graph->AddNode(1);
...
TEST(TUNGraph, GetSAttrDatE_str) {
  PUNGraph Graph;
  Graph = TUNGraph::New();
  Graph->AddNode(0);
  Graph->AddNode(1);
