...
/// If the input graph is directed we treat it as undirected (multigraph), i.e., we ignore the edge directions but there may be two undirected edges between a pair of nodes.
